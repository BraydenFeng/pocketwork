...
export const templates: Template[] = [
	{ id: "deep-work", name: "Deep work", tagline: "90 minutes, apps locked, one task in front of you.", build: () => ({
		...
		blocks: [
			...
			{ id: "shield", type: "screen_time", title: "Distractions stay out", mode: "block", groups: ["Distractions"] },
		],
		rules: focus_rules,
	}) },
	{ id: "study-sprint", name: "Study sprints", tagline: "45-minute sprints, count them up, phone stays quiet.", build: () => ({
		...
		blocks: [
			...
			{ id: "shield", type: "screen_time", title: "Nothing but the books", mode: "block", groups: ["Distractions"] },
		],
		rules: focus_rules,
	}) },
	{ id: "bedtime", name: "Phone-free bedtime", tagline: "Every night from 10 PM, the scrolling apps lock themselves until 7 AM.", build: () => ({
		...
		blocks: [
			...
			{ id: "shield", type: "screen_time", title: "Feeds off for the night", mode: "block", groups: ["Social"] },
		],
		rules: { block_during_focus: true, notify_on_complete: false },
		enabled: false,
	}) },
	{ id: "workday", name: "Workday focus", tagline: "Weekdays 9 to 5, only your Work apps open; everything else waits.", build: () => ({
		...
		blocks: [
			...
			{ id: "shield", type: "screen_time", title: "Only work apps until five", mode: "allow_only", groups: ["Work"] },
		],
		rules: { block_during_focus: true, notify_on_complete: false },
		enabled: false,
	}) },
	{ id: "morning", name: "Morning start", tagline: "A short checklist and 25 quiet minutes before the phone opens.", build: () => ({
		...
		blocks: [
			...
			{ id: "shield", type: "screen_time", title: "Feeds wait until you're done", mode: "block", groups: ["Social"] },
		],
		rules: focus_rules,
	}) },
	{ id: "reading", name: "Reading time", tagline: "30 minutes with a book and a page counter, apps locked.", build: () => ({
		...
		blocks: [
			...
			{ id: "shield", type: "screen_time", title: "The feed can wait", mode: "block", groups: ["Social"] },
		],
		rules: focus_rules,
	}) },
];
