...
struct HomeAllowanceView: View {
	...
	var body: some View {
		...
		.toolbar { ToolbarItem(placement: .topBarTrailing) { Button("Edit") { showing_editor = true }.disabled(sessions.is_busy) } }
		.sheet(isPresented: $showing_editor) { HomePolicyEditorView(document: document) }
